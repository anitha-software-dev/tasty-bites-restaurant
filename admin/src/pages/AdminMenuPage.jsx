...
const AdminMenuPage = () => {
    ...
    const handleSave = async (itemData) => {
        try {
            if (selectedItem) {
                await adminMenuApi.update(selectedItem.id, itemData);
            } else {
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full text-left">
                            <thead className="bg-slate-50/50 border-b border-slate-100">
                                <tr>
                                    <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-widest">Preview</th>
                                    ...
                                    <th className="px-8 py-5 text-[10px] font-bold text-slate-400 uppercase tracking-widest text-center">Badges</th>

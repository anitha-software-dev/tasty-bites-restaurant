    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center pt-24 pb-12 px-6">
            <div className="w-full max-w-md">
                {/* Back Button */}
                <div className="flex items-center space-x-2 text-slate-500 hover:text-primary transition-colors mb-8 cursor-pointer" onClick={() => navigate(-1)}>
                    <ArrowLeft size={18} />
                    <span>Back</span>
                </div>
                ...
                >
                    ...
                    <div className="text-center mb-10 relative z-10">
                        ...
                        <h1 className="text-3xl font-playfair text-slate-900 mb-2">Sign In</h1>
                        <p className="text-slate-500 text-sm">Welcome back to Tasty Bites</p>
                    </div>

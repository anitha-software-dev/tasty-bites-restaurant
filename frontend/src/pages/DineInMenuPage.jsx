                ...
                <div className="absolute inset-0 flex items-start sm:items-center justify-center container mx-auto px-6 z-10 text-center pt-40 sm:pt-0">
                    <div className="max-w-2xl mx-auto flex flex-col items-center">
                        <motion.div
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-amber-400/20 backdrop-blur-md border border-amber-400/30 text-amber-400 rounded-full text-[10px] sm:text-xs font-bold uppercase tracking-[0.3em] mb-4 sm:mb-6 whitespace-nowrap"
                        >
                            <Award size={16} /> Exquisite Dining
                        </motion.div>

    ...
    return (
        <div className="space-y-8 pb-20">
            <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-8">
                <div>
                    <h1 className="text-4xl font-playfair font-black text-slate-900 mb-3">Catering</h1>
                    <p className="text-slate-500 font-medium italic">Event requests</p>
                </div>
                            ...
                            {loading ? (
                                ...
                                <tr>
                                    <td colSpan="5" className="p-40 text-center">
                                        ...
                                        <h3 className="text-2xl font-playfair font-black text-secondary">None Found</h3>
                                        <p className="text-gray-400 mt-2 font-medium italic">No new requests.</p>
                                    </td>
                                </tr>
                            )}
                        </tbody>
